...
?>" || 0;
        ...
        $("#project-table").appTable({
            ...
            columns: [
                ...
                {visible: false, searchable: false}, // Hide the status column using the visibility property
                {title: '<?php echo app_lang("deadline") ?>', "class": "w10p", "iDataSort": 6},
                // {title: '<?php echo app_lang("progress") ?>', "class": "w15p"},
                {title: '<?php echo app_lang("last_modified") ?>', "class": "w10p"},
                {title: '<?php echo app_lang("status") ?>', "class": "w10p", visible: false} // Status column is hidden using the visibility property
