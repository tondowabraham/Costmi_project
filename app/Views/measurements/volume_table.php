            ...
            <?php foreach ($measurements as $key => $measurement): ?>
                <?php if ($measurement['measurement_type'] === 'volume'): ?>
                    <tr>
                        ...
                        <td><?= $measurement['volume_timesing'] ?></td>
                        <td><?= $measurement['volume_number_of'] ?></td>
                        <td><?= $measurement['volume_length'] ?></td>
                        <td><?= $measurement['volume_breadth'] ?></td>
                        <td><?= $measurement['volume_height'] ?></td>
                        <td><?= $measurement['volume_description'] ?></td>
                        <td><?= $measurement['volume_quantity'] ?></td>
                        <td><?= $measurement['volume_total'] ?></td>
                        <td><?= $measurement['volume_unit'] ?></td>
                        <td>
                            <?php
