...
class App_Controller extends Controller {
    ...
    public $Resources_model;
    public $Costs_model;
    public $Production_model;
    public $Bills_model;
    public $Measurements_model;
    public $Direct_costs_model;
    public $Indirect_costs_model;
    public $Approximate_Estimates_model;
    public $Schedules_model;
    public $Consultancy_fees_model;
    public $Bill_summary_model;
    ...
    private function get_models_array() {
        return array(
            ...
            'Measurements_model',
            'Direct_costs_model',
            'Indirect_costs_model',
            'Approximate_Estimates_model',
            'Schedules_model',
            'Consultancy_fees_model',
            'Bill_summary'
        );
    }
