...
class Projects extends Security_Controller {
    ...
    public function __construct() {
        ...
        $this->Measrurements_model = model('App\Models\Measurements_model');
    }
    ...
    private function _make_row($data, $custom_fields) {
        ...
        $last_modified = is_date_exists($data->last_modified) ? format_to_date($data->last_modified, false) : "-";
    ...
    function view($project_id = 0, $tab = "") {
        ...
        $this->overview_for_client($project_id);
